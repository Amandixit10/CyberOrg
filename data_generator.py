...
# #                 "cvss_base_score": data.get("cvss_v3_metrics", {}).get("base_score"),
# #                 "cvss_temporal_score": data.get("cvss_v3_metrics", {}).get("temporal_score"),
# #                 "cvss_overall_score": data.get("cvss_v3_metrics", {}).get("overall_score"),
# #                 "vector": data.get("cvss_v3_metrics", {}).get("vector")
# #             }
...
# #                 results.append(data)
# #             else:
# #                 logger.info(f"No more valid data after {current_id}, stopping")
# #                 break
